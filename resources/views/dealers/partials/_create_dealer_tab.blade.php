<div class="row justify-content-md-center">
	<div class="col-md-10">
		...
		<form action="{{ route('dealers.store') }}" method="POST" id="create-dealer-form">
		{{ csrf_field() }}
		...
		<div class="input-group">
			...
			<input type="text" name="type" class="form-control" placeholder="Type" aria-label="type" aria-describedby="type" value="dealer" readonly>
		</div>
		<br>
		<div class="input-group">
		...
		<br>
		<hr>
		<button type="submit" class="btn btn-primary btn-block" id="create-dealer-btn">Create</button>
		</form>
	</div>
</div>